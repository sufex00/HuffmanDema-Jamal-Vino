...
QString huffdecotification::TreeRepresentation()
{
...
bool huffdecotification::isElement(Nodes* node,QString HuffmanCodification)
{
    bool boolReturn;
...
char huffdecotification::getElementTree(Nodes* node,QString HuffmanCodification)
{
    char charReturn;
    if(node->isLeaf() != true)
    {
...
QString huffdecotification::TreeHuffmanTreeRight(QString huff)
{
    ...
    huff.remove(1,TreeHuffmanDecodificationLeft.size());
    QString TreeHuffmanDecodificationRight=TreeHuffmanTreeLeft(huff);
    return TreeHuffmanDecodificationRight;
}

Nodes* huffdecotification::generation(QString Tree)
{
    Nodes* Left;
    Nodes* Right;
    QString TreeLeft=TreeHuffmanTreeLeft(Tree);
    QString TreeRight=TreeHuffmanTreeRight(Tree);
    if(TreeLeft.size()>1)
    {
    ...
    {
        Left=new Nodes(TreeLeft.at(0).toLatin1(),0);
    }
    if(TreeRight.size()>1)
    {
    ...
    {
        Right = new Nodes(TreeRight.at(0).toLatin1(),0);
    }
